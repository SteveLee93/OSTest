...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_3.setGeometry(QRect(10, 20, 611, 321))
        ...
        self.gridLayoutWidget_5.setGeometry(QRect(320, 70, 279, 221))
        ...
        self.gridLayout_5.addWidget(self.label_38, 0, 0, 1, 2)

        self.dial_Dir = QDial(self.gridLayoutWidget_5)
        self.dial_Dir.setObjectName(u"dial_Dir")
        self.dial_Dir.setMinimum(1)
        self.dial_Dir.setMaximum(4)

        self.gridLayout_5.addWidget(self.dial_Dir, 3, 2, 2, 1)

        self.lb_SP_RightState = QLabel(self.gridLayoutWidget_5)
        self.lb_SP_RightState.setObjectName(u"lb_SP_RightState")
        self.lb_SP_RightState.setAlignment(Qt.AlignHCenter|Qt.AlignTop)

        self.gridLayout_5.addWidget(self.lb_SP_RightState, 4, 3, 1, 1)

        self.label_33 = QLabel(self.gridLayoutWidget_5)
        self.label_33.setObjectName(u"label_33")
        self.label_33.setAlignment(Qt.AlignBottom|Qt.AlignHCenter)
        ...
        self.lb_SP_TopState.setAlignment(Qt.AlignHCenter|Qt.AlignTop)

        self.gridLayout_5.addWidget(self.lb_SP_TopState, 1, 2, 1, 1)

        self.lb_SP_LeftState = QLabel(self.gridLayoutWidget_5)
        self.lb_SP_LeftState.setObjectName(u"lb_SP_LeftState")
        self.lb_SP_LeftState.setAlignment(Qt.AlignHCenter|Qt.AlignTop)

        self.gridLayout_5.addWidget(self.lb_SP_LeftState, 4, 1, 1, 1)

        self.label_35 = QLabel(self.gridLayoutWidget_5)
        self.label_35.setObjectName(u"label_35")
        self.label_35.setAlignment(Qt.AlignBottom|Qt.AlignHCenter)
        ...
        self.gridLayout_5.addWidget(self.lb_SP_BottomState, 6, 2, 1, 1)
        ...
        self.label_37.setAlignment(Qt.AlignBottom|Qt.AlignHCenter)
        ...
        self.gridLayoutWidget.setGeometry(QRect(30, 20, 181, 77))
        ...
        self.gridLayoutWidget_2.setGeometry(QRect(30, 20, 171, 77))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_SP_RightState.setText(QCoreApplication.translate("MainWindow", u"NeedHome", None))
        self.label_33.setText(QCoreApplication.translate("MainWindow", u"-\uc548\uc500-", None))
        ...
        self.le_SV_MaxTime.setText(QCoreApplication.translate("MainWindow", u"0", None))
